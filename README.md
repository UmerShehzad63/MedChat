...
MedChat is a retrieval-augmented medical information assistant built with Streamlit and LangChain. It provide strict, evidence-based answers using a local document database.
```
